...
namespace ZeroBlog.Tests
{
    public abstract class ZeroBlogTestBase : AbpIntegratedTestBase<ZeroBlogTestModule>
    {
        ...
        protected void UsingDbContext(Action<ZeroBlogDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<ZeroBlogDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<ZeroBlogDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<ZeroBlogDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<ZeroBlogDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<ZeroBlogDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<ZeroBlogDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<ZeroBlogDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<ZeroBlogDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<ZeroBlogDbContext, Task<T>> func)
        {
            T result;
